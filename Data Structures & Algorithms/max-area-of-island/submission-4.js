// MY SOLUTION OPTIMAL
// USES NUM OF ISLANDS DFS ANSWER
// + TRACK ISLAND AREA COUNT IN A TEMP VAR
//   & STORE LARGEST COUNT IN ANOTHER VAR VIA MATH.MAX() 
//   COMPARE OF THE TEMP VAR VS EXISTING LARGEST
class Solution {
    /**
    ...
    maxAreaOfIsland(grid) {
        ...
        let islandsAreaMax = 0; // Track largest island area found.
        ...
        const dfs = (r, c) => {
            ...
            if(
                ...
                islandAreaCount++; // incrememt area count.
        ...
        for(let row = 0; row < ROWS; row++){
            for(let col = 0; col < COLS; col++){
                if(grid[row][col] === 1){
                    ...
                    islandsAreaMax = Math.max(islandAreaCount, islandsAreaMax);
