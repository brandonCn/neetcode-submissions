class MinStack {
    ...
    push(val) {
        ...
        // If minStack is empty, ignore the compare, and just push current val onto the minStack.
        if(this.minStack.length !== 0){

            // Compare current push val to the current top of the min stack.
            // - Math.min() picks the smallest of the two values.
            //   If current val is smaller, push that to minStack;
            //   else, push the top of minStack to minStack again.
