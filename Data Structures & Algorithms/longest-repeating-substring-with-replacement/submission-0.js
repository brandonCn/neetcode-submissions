class Solution {
    ...
    characterReplacement(s, k) {
        ...
        // - We will loop through the string per unique character. 
        ...
        for (let c of charSet) {
            ...
            // r is end of window.
            // From the start of the string, expand the window 
            ...
            for (let r = 0; r < s.length; r++) {
                ...
                while (r - l + 1 - count > k) {
                    if (s[l] === c) {
                        // If the window is losing the character 
                ...
                // Store window size if larger than largest found.
